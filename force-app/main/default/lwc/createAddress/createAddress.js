...
export default class createAddress extends LightningElement {

    
    recordId ="Address__c.Id";
    objectApiName ='Address__c';
    fields= [NAME_FIELD, ACCOUNT_FIELD, ADDRESS_TYPE_FIELD, MAIN_FIELD, ZIP_POSTAL_CODE_FIELD, 
                                                        STATE_PROVINCE_FIELD, STREET_FIELD, COUNTRY_FIELD, CITY_FIELD];
